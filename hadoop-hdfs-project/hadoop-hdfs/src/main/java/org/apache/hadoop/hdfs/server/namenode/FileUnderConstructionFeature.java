...
public class FileUnderConstructionFeature implements INode.Feature {
  ...
  public FileUnderConstructionFeature(final String clientName, final String clientMachine, final String diskGroup) {
    this.clientName = clientName;
    this.clientMachine = clientMachine;
    this.diskGroup = diskGroup;
  }

  public String getDiskGroup() { return diskGroup; }
