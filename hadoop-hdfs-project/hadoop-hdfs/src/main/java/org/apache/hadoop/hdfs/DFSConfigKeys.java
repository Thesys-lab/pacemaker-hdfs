...
public class DFSConfigKeys extends CommonConfigurationKeys {
  ...
  // Config keys for HeART
  public static final String HEART_REDUNDANCY_SCHEMES_LIST = "heart.redundancy.schemes.list";
  public static final String HEART_DISK_GROUPS_LIST = "heart.disk.groups.list";
  public static final String HEART_TRANSITION_BANDWIDTH = "heart.transition.bandwidth";
}
