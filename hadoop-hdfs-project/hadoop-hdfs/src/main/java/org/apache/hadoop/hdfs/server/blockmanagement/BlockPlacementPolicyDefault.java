...
//    LOG.info("In choose target 3, numOfReplicas = " + numOfReplicas + ", clusterMap.getNumOfLeaves() = " +
...
//    LOG.info("In choose target 7");
  ...
  protected int addToExcludedNodes(DatanodeDescriptor localMachine,
      Set<Node> excludedNodes) {
    LOG.info("excluded nodes in default class.");
