...
//   * Command to ask the namenode to reread the hosts and excluded hosts
//   * file.
//   * Usage: hdfs dfsadmin -refreshNodes <disk-group>
//   * @exception IOException
//   */
//  public int refreshNodes(String diskGroup) throws IOException {
//    int exitCode = -1;
//
//    DistributedFileSystem dfs = getDFS();
//    Configuration dfsConf = dfs.getConf();
...
//      for (ProxyAndInfo<ClientProtocol> proxy: proxies) {
//        try{
//          proxy.getProxy().refreshNodes(diskGroup);
//          System.out.println("Refresh nodes successful for " +
//              proxy.getAddress());
//        }catch (IOException ioe){
//          System.out.println("Refresh nodes failed for " +
...
//      } else if ("-refreshDiskGroupNodes".equals(cmd)) {
//        exitCode = refreshNodes(argv, i);
      } else if ("-finalizeUpgrade".equals(cmd)) {
