...
class HeartbeatManager implements DatanodeStatistics {
  ...
  final String diskGroup;

  HeartbeatManager(final Namesystem namesystem,
      final BlockManager blockManager, final Configuration conf, String diskGroup) {
  ...
  @VisibleForTesting
  void heartbeatCheck(String diskGroup) {
