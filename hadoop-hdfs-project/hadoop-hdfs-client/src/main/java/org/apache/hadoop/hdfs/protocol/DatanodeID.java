...
public class DatanodeID implements Comparable<DatanodeID> {
  ...
  public DatanodeID(String datanodeUuid, DatanodeID from) {
    this(from.getIpAddr(),
        ...
        from.getIpcPort(), from.getDiskGroup());
  ...
  public DatanodeID(String ipAddr, String hostName, String datanodeUuid,
      int xferPort, int infoPort, int infoSecurePort, int ipcPort, String diskGroup) {
    this(ipAddr, getByteString(ipAddr),
        hostName, getByteString(hostName),
        datanodeUuid, getByteString(datanodeUuid),
        xferPort, infoPort, infoSecurePort, ipcPort, diskGroup);
  }
  ...
  public String getDiskGroup() { return this.diskGroup; }
